...
## Na abertura (dia 1)
- **Fee-for-service simples, transparente e uniforme**: valor fixo ou % fixo por
  consulta realizada, fácil de administrar.
- **Guard-rail ético (desde o dia 1):** nenhum pagamento ao médico por exame ou
  procedimento solicitado — elimina demanda induzida. Pedido segue protocolo e é auditado.
