...
- Hierarquia de precedencia para desempate entre principios.
- Estrategia (missao/visao/expansao) e registro de agentes de IA (`90-meta/catalog/agents.yaml`).

## [0.1.0] - 2026-07-02
### Added
- Estrutura inicial do Company OS (ADR 0001).
- Padroes, templates, glossario e catalogo em `90-meta`.
- Dominio-referencia `clinical-care` totalmente instanciado.
